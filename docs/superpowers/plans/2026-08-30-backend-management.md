...
**执行记录：** 阶段审查额外发现“停止 Context 提前到期可能遗留进程组”的边界，已增加回归测试并改为到期时强制 `SIGKILL` 后等待回收。

**Files:**
- Modify: `README.md`
- Modify: `docs/superpowers/plans/2026-08-30-backend-management.md`

- [x] **Step 1: README 增加 Profile、命令信任边界和日志说明**
