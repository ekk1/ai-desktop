...
- [ ] **Step 1: 创建 Go Module，并写 Store 失败测试**
...
- [ ] **Step 3: 使用标准库 `syscall.Flock` 实现 Linux 排他锁**
...
- [ ] **Step 3: 实现路由、错误 Envelope 和安全响应头**
